...
> - Уникнення галюцинацій, навички критика (grill-me) та доказовість: протокол `[uncertain]`, стрес-допит рішень критика `/grill-me`, заземлення через CodeGraph, мутаційне тестування Red Evidence та виробничі метрики продуктивності (див. [README.md (Розділи 2.5, 4.6, 4.7)](README.md#46-інженерна-дисципліна-уникнення-галюцинацій-моделей-та-доказова-верифікація-anti-hallucination-framework)).
