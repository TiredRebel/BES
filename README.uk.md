...
> - Уникнення галюцинацій та доказовість: обов'язкова фіксація виводу терміналу, протокол `[uncertain]`, заземлення через CodeGraph та мутаційне тестування Red Evidence (див. [README.md (Розділ 4.6)](README.md#46-інженерна-дисципліна-уникнення-галюцинацій-моделей-та-доказова-верифікація-anti-hallucination-framework)).

## Документація (Documentation)

- **[README.en.md](README.en.md)**: Англомовна версія цього файлу (English version of this README).
- **[AGENTS.md](AGENTS.md)**: Інструкції для агентів кодування (Claude Code, Cursor, Codex, Antigravity).
