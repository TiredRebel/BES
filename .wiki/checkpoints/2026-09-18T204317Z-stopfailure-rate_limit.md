---
title: "Checkpoint 2026-09-18 20:43:17Z (stopfailure-rate_limit)"
type: checkpoint
status: auto
updated: 2026-09-18
related: ["[[index]]", "[[log]]"]
...
# Checkpoint 2026-09-18 20:43:17Z (stopfailure-rate_limit)
...
- Working tree (7 changed paths, first 40):
...
> Reviewer 2 of 5 (comments) is done: 4 major, 10 minor and 7 nit, all about docs that claim more than the code does. I'll check each major against the code at triage.
> - **C01:** the service-half test's doc overstates when it goes red.
> - **C02:** the schema test says "exactly" but only checks that the objects are present.
> - **C03:** duplicates SF4.
> - **C04:** the email index doc claims case-insensitivity the index doesn't provide.
> 
> Waiting for the last reviewer (tests).
