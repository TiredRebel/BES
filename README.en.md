...
> - Engineering lifecycle, planning phase (Zero-Code Planning, Human Gate), Agile iterations, critic skills (grill-me) & evidence-based verification: terminal output verification, `[uncertain]` protocol, `/grill-me` adversarial review, CodeGraph grounding, Red Evidence mutation testing, and production performance metrics (see [README.md (Sections 2.5, 4.6, 4.7)](README.md#фази-інженерного-процесу-та-agile-підхід-agile-lifecycle--engineering-phases)).
