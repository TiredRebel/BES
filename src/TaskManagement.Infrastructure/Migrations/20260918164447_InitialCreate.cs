...
// Seed rows (demo data)
//   employees: 10000000-…-0001 Олена Коваленко (active), 10000000-…-0002 Богдан Шевченко (active),
//              10000000-…-0003 Оксана Мельник (inactive)
//   tasks:     20000000-…-0001 'Підготувати квартальний звіт з продажів' New, Олена -> Богдан
//              20000000-…-0002 'Передзвонити ключовому клієнту' Completed, Богдан -> Олена
//              20000000-…-0003 'Очистити дублікати контактів' Cancelled, Олена -> Богдан
using System;
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), "olena.kovalenko@example.com", "Олена Коваленко", true },
                    { new Guid("10000000-0000-0000-0000-000000000002"), "bohdan.shevchenko@example.com", "Богдан Шевченко", true },
                    { new Guid("10000000-0000-0000-0000-000000000003"), "oksana.melnyk@example.com", "Оксана Мельник", false }
                });
